...
function populateCols (src) {
    ...
    // add the date filter inputs
    d3.select("div.sidePane")
        .append("div")
        .attr("class", "dateInput") ;

    d3.select("div.dateInput")
        .selectAll("div.dateRow")
        .data([["dateint from:", "<input type=\"text\" class=\"dateFrom\">"], ["dateint to:", "<input type=\"text\" class=\"dateTo\">"]])
        .enter()
        .append("div")
        .attr("class", "dateRow") ;

    d3.selectAll("div.dateRow")
        .selectAll("div.dateEntry")
        .data(function(d) { return d; })
        .enter()
        .append("div")
        .attr("class", "dateCell")
